...
<head>
    ...
    <title>Login Administrator Siplab</title>
...
<style>
    body {
        background-image:url('img/lab.jpg'); background-size:cover
}
</style> 
</head>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading"><center>
                        <img src="img/unib.png" width="70" height="70">
                        <h3 class="panel-title">LOGIN</h3>
                        <h3 class="panel-title">SISTEM INFORMASI PENJADWALAN LAB</h3></center>
                    </div>
